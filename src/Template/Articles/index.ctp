    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('body2') ?></th>

                <th scope="col"><?= $this->Paginator->sort('about3') ?></th>
                <th scope="col"><?= $this->Paginator->sort('title3') ?></th>
                <th scope="col"><?= $this->Paginator->sort('img3') ?></th>
                <th scope="col"><?= $this->Paginator->sort('body3') ?></th>

                <th scope="col"><?= $this->Paginator->sort('about4') ?></th>
                <th scope="col"><?= $this->Paginator->sort('title4') ?></th>
                <th scope="col"><?= $this->Paginator->sort('img4') ?></th>
                <th scope="col"><?= $this->Paginator->sort('body4') ?></th>
               -
