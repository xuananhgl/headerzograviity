                    ...
                    <div id="lider" style="background-color:<?= $interface['backgroun_header'] ?>">
                                <div class="video js-video">
                                    <button class="bnt_video js-close-video">  <i class="fa-solid fa-xmark " style="cursor: pointer;"></i> </i></button>
                                            <div class="set_video">
                               <iframe width="1180" height="664" src="https://www.youtube.com/embed/JP9IIlOKafs"
                     ...
                     <div class="header_container" >
                            ...
                            <?= $this->Html->image($interface->image_header) ?>
                                ...
                                <div class="container_title">
                                        <h1 class="font_blue" style="color: <?= $interface['color_header'] ?>;">  <?= $header['about']?></h1>
                                
                                
                                <div class="container_about">
                                    <p style="color: <?= $interface['color_header'] ?>;"><?= $header['title']?></p>
                                </div>
                            ...
                            <div class="slider_content">
                                <div class="slider_titel"><p><?=$data['title'] ?></p>
                                    ...
                                    <div class="slider_note">
                                        <div class="note"><a href="" style="color:#000";><?= $data['author']?></a><br><a><?= $data['dress']?></a></div> 
                                        <div class="cycle"><a href="<?= $data['link']?>" style="color:#000";><?=__('Lire l’article')  ?>   <i class="fa-solid fa-arrow-up-right-from-square"></i></a></div> 
                                    </div>
    ...
    <div class="list_item">
            ...
            <div class="slider_content">
                <div class="slider_titel"><p><?=$data['title']?></p>
                    ...
                    <div class="slider_h1"><?= $this->Html->image($data->logo2) ?></h1></div>
                    <div class="slider_about"><?= __($data['about2'])?></div>
                    <div class="slider_note">
                        <div class="note"><a href="" style="color:#000";><?= $data['author2']?></a><br><a><?= $data['dress2']?></a></div> 
                                        <div class="cycle"><a href="<?= $data['link2']?>" style="color:#000";><?=__('Lire l’article')?><i class="fa-solid fa-arrow-up-right-from-square"></i></a></div> 
                     </div>
                     <div class="slide_box2"></div>
            </div>
    ...
    <div class="list_item">
             ...
             <div class="slider_content">
                <div class="slider_titel"><p><?= $data['title'] ?></p>
                    ...
                    <div class="slider_h1"><?= $this->Html->image($data->logo3) ?></h1></div>
                    <div class="slider_about"><?= __($data['about3'])?></div>
                    <div class="slider_note">
                        <div class="note"><a href="" style="color:#000";><?= $data['author3']?></a><br><a><?= $data['dress3']?></a></div> 
                                        <div class="cycle"><a href="<?= $data['link3']?>" style="color:#000";><?=__('Lire l’article')?><i class="fa-solid fa-arrow-up-right-from-square"></i></a></div> 
                     </div>
                     <div class="slide_box2"></div>
            </div>
...
<?php foreach ($pours as $pour): ?>
        <div id="content">
            ...
            <div class="content_about">
                <div class="content_about_title"><?= $pour['title'] ?></div>
            ...
            <div class="news_nos">
                ...
                <div class="nos_content">
                    <div class="conten_nos1">
                        <div class="conten_nos1_img"><?= $this->Html->image($article['img']) ?></div>
                        <div class="conten_nos1_caption"><?= $article['title'] ?></div>
                        
                        <div class="conten_nos1_time">
                            <div class="conten_nos1_note"><?= $article['about']?></div>15 min
                        </div>
                        <div class="conten_nos1_about"><?= $article['body'] ?></div>
                        <div class="conten1 nos_btn"><a href=""><?= __('Lire l’article') ?></a></div>
                    </div>
                    <div class="conten_nos2">
                        <div class="conten_nos2_img"><?= $this->Html->image( $article['img2'] ) ?></div>
                        <div class="conten_nos2_char">
                            <div class="conten_nos2_caption"><?= $article['title2'] ?></div>
                            
                            <div class="conten_nos2_time">
                                <div class="conten_nos2_note"><?= $article['about2'] ?></div>10 min
                            </div>
                            <div class="conten_nos2_about"><?= $article['body2'] ?></div>
                            <div class="conten2 nos_btn"><a href=""><?= __('Lire l’article') ?></a></div>
                        </div>
                    </div>
                    <div class="conten_nos4">
                        <div class="conten_nos4_img"></div>
                        <div class="conten_nos4_caption"><?= $article['title3'] ?></div>
                        
                        <div class="conten_nos4_time">
                            <div class="conten_nos4_note"><?= $article['about3'] ?></div>8 min
                            
                        </div>
                        <div class="conten_nos4_about"><?= $article['body3'] ?></div>
                        <div class="conten4 nos_btn"><a href=""><?= __('Lire l’article') ?></a></div>
                    </div>

                    <div class="conten_nos3">
                        <div class="conten_nos3_img"></div>
                        <div class="conten_nos3_caption"><?= $article['title4'] ?></div>
                        
                        <div class="conten_nos3_time">
                            <div class="conten_nos3_note"><?= $article['about4'] ?></div>12 min
                        </div>
                        <div class="conten_nos3_about"><?= $article['body4'] ?></div>
        ...
        <div id="footer">
            <div class="footer_menu">
                ...
                <div class="footer_list">
                    <ul>
                        <li><?= __('Entreprises1') ?></li>
                        <li><?= __('Collectivités1') ?></li>
                        <li><?= __('À PROPOS') ?></li>
                        <li><?= __('CONTACT') ?></li>
                        <li><?= __('BLOG') ?></li>
                    </ul>
                ...
                <?php
                                      ...
                                      echo $this->Form->radio("locale",
                                          [
                                              ...
                                              ['value'=>'vi_VN','text'=>'tiengviet'],
                                               ['value'=>'fr_FR','text'=>'franse'],
