    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('author2') ?></th>
                <th scope="col"><?= $this->Paginator->sort('dress2') ?></th>
                <th scope="col"><?= $this->Paginator->sort('about3') ?></th>
                <th scope="col"><?= $this->Paginator->sort('author3') ?></th>
                <th scope="col"><?= $this->Paginator->sort('dress3') ?></th>
