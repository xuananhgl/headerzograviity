  ...
  <fieldset>
    <legend><?= __('Add New Fresse') ?></legend>
     ...
     <?= $this->Form->control('logo');?>
      <?= $this->Form->control('logo2');?>
       <?= $this->Form->control('logo3');?>
     <legend>Dynamic-content</legend>
      <?= $this->Form->control('link', ['rows' => '1']);?>
    <?= $this->Form->control('link2', ['rows' => '1']);?>
    <?= $this->Form->control('link3', ['rows' => '1']);?>
     <?= $this->Form->control('author', ['rows' => '1']);?>
     <?= $this->Form->control('dress', ['rows' => '1']);?>
     <?= $this->Form->control('about', ['rows' => '1']);?>
     <?= $this->Form->control('author2', ['rows' => '1']);?>
     <?= $this->Form->control('dress2', ['rows' => '1']);?>
     <?= $this->Form->control('about2', ['rows' => '1']);?>
    <?= $this->Form->control('author3', ['rows' => '1']);?>
     <?= $this->Form->control('dress3', ['rows' => '1']);?>
     <?= $this->Form->control('about3', ['rows' => '1']);?>
    ...
    <?= $this->Form->control('_translations.en_US.about2', ['rows' => '1']); ?>
    <?= $this->Form->control('_translations.en_US.author2', ['rows' => '1']); ?>
    <?= $this->Form->control('_translations.en_US.dress2', ['rows' => '1']); ?>
    <?= $this->Form->control('_translations.en_US.about3', ['rows' => '1']); ?>
    <?= $this->Form->control('_translations.en_US.author3', ['rows' => '1']); ?>
    <?= $this->Form->control('_translations.en_US.dress3', ['rows' => '1']); ?>
    ...
    <?= $this->Form->control('_translations.es.about2', ['rows' => '1']); ?>
    <?= $this->Form->control('_translations.es.author2', ['rows' => '1']); ?>
    <?= $this->Form->control('_translations.es.dress2', ['rows' => '1']); ?>
    <?= $this->Form->control('_translations.es.about3', ['rows' => '1']); ?>
    <?= $this->Form->control('_translations.es.author3', ['rows' => '1']); ?>
    <?= $this->Form->control('_translations.es.dress3', ['rows' => '1']); ?>
    ...
    <?= $this->Form->control('_translations.vi_VN.dress', ['rows' => '1']); ?>
      <?= $this->Form->control('_translations.vi_VN.about2', ['rows' => '1']); ?>
    <?= $this->Form->control('_translations.vi_VN.author2', ['rows' => '1']); ?>
    <?= $this->Form->control('_translations.vi_VN.dress2', ['rows' => '1']); ?>
      <?= $this->Form->control('_translations.vi_VN.about3', ['rows' => '1']); ?>
    <?= $this->Form->control('_translations.vi_VN.author3', ['rows' => '1']); ?>
    <?= $this->Form->control('_translations.vi_VN.dress3', ['rows' => '1']); ?>
