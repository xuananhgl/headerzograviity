...
<div class="users view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            <th scope="row"><?= __('') ?></th>
            <td><?= h($interface->author) ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('About', ['rows' => '3']) ?></th>
            <td><?= h($interface->about) ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Dress') ?></th>
            <td><?= h($interface->dress) ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Link') ?></th>
            <td><?= h($interface->link) ?></td>
        </tr>
    </table>
                    ...
                    <?= $this->Form->postLink(__('Delete'), ['controller' => 'Interfaces', 'action' => 'delete', $interface->id], ['confirm' => __('Are you sure you want to delete # {0}?', $pre->id)]) ?>
                </td>
            </tr>
